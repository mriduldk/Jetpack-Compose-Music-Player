package com.codingstudio.jetpackcomposemusicplayer.data.service
...
import com.codingstudio.jetpackcomposemusicplayer.data.mapper.toSong
            ...
            MediaItem.Builder()
                ...
                .setMediaMetadata(
                    MediaMetadata.Builder()
                        ...
                        .setSubtitle(it.name)
                        .setArtist(it.artist)
                        .setArtworkUri(Uri.parse(it.cover))
                        .setGenre(it.accent)
                        .build()
                )
                .build()
